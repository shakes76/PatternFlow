...
def ImprovedUnet(h, w, n_channels):
    ...
    #Block 1 (Context)
    b1_ds = tf.keras.layers.Conv2D(F[0], (3,3), padding = 'same')(input_layer)
    b1_res = b1_ds
    b1_m_c1n = tf.keras.layers.BatchNormalization()(b1_ds)
    b1_m_c1a = tf.keras.layers.LeakyReLU(alpha=0.01)(b1_m_c1n)
    b1_m_c1 = tf.keras.layers.Conv2D(F[0], (3,3), padding = 'same')(b1_m_c1a)
    ...
    b1_m_c2 = tf.keras.layers.Conv2D(F[0], (3,3), padding = 'same')(b1_m_c2a)
    ...
    b2_m_c1 = tf.keras.layers.Conv2D(F[1], (3,3), padding = 'same')(b2_m_c1a)
    ...
    b2_m_c2 = tf.keras.layers.Conv2D(F[1], (3,3), padding = 'same')(b2_m_c2a)
    ...
    b3_m_c1 = tf.keras.layers.Conv2D(F[2], (3,3), padding = 'same')(b3_m_c1a)
    ...
    b3_m_c2 = tf.keras.layers.Conv2D(F[2], (3,3), padding = 'same')(b3_m_c2a)
    ...
    b4_m_c1 = tf.keras.layers.Conv2D(F[3], (3,3), padding = 'same')(b4_m_c1a)
    ...
    b4_m_c2 = tf.keras.layers.Conv2D(F[3], (3,3), padding = 'same')(b4_m_c2a)
    ...
    b5_m_c1 = tf.keras.layers.Conv2D(F[4], (3,3), padding = 'same')(b5_m_c1a)
    ...
    b5_m_c2 = tf.keras.layers.Conv2D(F[4], (3,3), padding = 'same')(b5_m_c2a)
    ...
    b6_m_c1 = tf.keras.layers.Conv2D(F[3], (3,3), padding = 'same')(b6_con)
    ...
    b7_m_c1 = tf.keras.layers.Conv2D(F[2], (3,3), padding = 'same')(b7_con)
    ...
    b8_m_c1 = tf.keras.layers.Conv2D(F[1], (3,3), padding = 'same')(b8_con)
    ...
    b9_m_c1 = tf.keras.layers.Conv2D(F[0], (3,3), padding = 'same')(b9_con)
