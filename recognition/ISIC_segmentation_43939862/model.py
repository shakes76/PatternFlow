...
def ImprovedUnet(h, w, n_channels):
    ...
    b1_res = b1_ds
    b1_m_c1 = tf.keras.layers.Conv2D(F[0], (3,3), padding = 'same')(b1_ds)
    ...
    b1_m_c2 = tf.keras.layers.Conv2D(F[0], (3,3), padding = 'same')(b1_m_do)
    ...
    b2_res = b2_ds
    b2_m_c1 = tf.keras.layers.Conv2D(F[1], (3,3), padding = 'same')(b2_ds)
    ...
    b2_m_c2 = tf.keras.layers.Conv2D(F[1], (3,3), padding = 'same')(b2_m_do)
    ...
    b3_res = b3_ds
    b3_m_c1 = tf.keras.layers.Conv2D(F[2], (3,3), padding = 'same')(b3_ds)
    ...
    b3_m_c2 = tf.keras.layers.Conv2D(F[2], (3,3), padding = 'same')(b3_m_do)
    ...
    b4_res = b4_ds
    b4_m_c1 = tf.keras.layers.Conv2D(F[3], (3,3), padding = 'same')(b4_ds)
    ...
    b4_m_c2 = tf.keras.layers.Conv2D(F[3], (3,3), padding = 'same')(b4_m_do)
    ...
    b5_res = b5_ds
    b5_m_c1 = tf.keras.layers.Conv2D(F[4], (3,3), padding = 'same')(b5_ds)
    ...
    b5_m_c2 = tf.keras.layers.Conv2D(F[4], (3,3), padding = 'same')(b5_m_do)
