def Predict():
 ...
 with open('path and filename of final model', 'rb') as file:
 ...
 plt.show()
 print(f'The best model has a mean ssim on the test set of {ssimtest}')# The mean ssim on the predictions of the best model on the test set