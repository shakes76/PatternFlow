...
def downsample(input, filters, kernel_size=(3, 3), padding="same", strides=(1, 1), kernel_initializer=HeNormal()):
    """
...
def upsample(input, skip, filters, kernel_size=(3, 3), padding="same", strides=(1, 1), kernel_initializer=HeNormal()):
    """
    ...
    concatenate = Concatenate()([upsample, skip]) # concatenate the skip and the deconvoluted layer together
...
def bottleneck(input, filters, kernel_size=(3, 3), padding="same", strides=(1, 1), kernel_initializer=HeNormal()):
    """
