...
def unet(input_size = (256,256,3)):
    ...
    c2 = Conv2D(32, (3, 3), activation='relu',kernel_initializer='he_normal', padding='same') (b1)
    c2 = Dropout(0.4) (c2)
    c2 = Conv2D(32, (3, 3), activation='relu',kernel_initializer='he_normal', padding='same') (c2)
    p2 = MaxPooling2D((2, 2)) (c2)
    b2 = BatchNormalization()(p2)

    c3 = Conv2D(64, (3, 3), activation='relu',kernel_initializer='he_normal', padding='same') (b2)
    c3 = Dropout(0.5) (c3)
    c3 = Conv2D(64, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same') (c3)
    p3 = MaxPooling2D((2, 2)) (c3)
    b3 = BatchNormalization()(p3)

    c4 = Conv2D(128, (3, 3), activation='relu',kernel_initializer='he_normal', padding='same') (b3)
    c4 = Dropout(0.4) (c4)
    c4 = Conv2D(128, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same') (c4)
    p4 = MaxPooling2D(pool_size=(2, 2)) (c4)
    b4 = BatchNormalization()(p4)

    c5 = Conv2D(256, (3, 3), activation='relu',kernel_initializer='he_normal',  padding='same') (b4)
    c5 = Dropout(0.4) (c5)
