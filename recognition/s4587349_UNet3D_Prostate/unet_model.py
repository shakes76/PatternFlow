...
def unet3d(inputsize= (256,256,128,1), kernelSize=3):  #increasse filters
    ...
    #1 c1 = tf.keras.layers.BatchNormalization()(c1)
    p1 = tf.keras.layers.MaxPooling3D(pool_size=(2, 2, 2), strides=(2, 2, 2))(c1)  #todo padding="same"?
    ...
    #1 c2 = tf.keras.layers.BatchNormalization()(c2)
    p2 = tf.keras.layers.MaxPooling3D(pool_size=(2, 2, 2), strides=(2, 2, 2))(c2)
    ...
    #1 c3 = tf.keras.layers.BatchNormalization()(c3)
    p3 = tf.keras.layers.MaxPooling3D(pool_size=(2, 2, 2), strides=(2, 2, 2))(c3)
    ...
    #1 c4 = tf.keras.layers.BatchNormalization()(c4)
    ...
    #1 c5 = tf.keras.layers.BatchNormalization()(c5)
    ...
    #1 c6 = tf.keras.layers.BatchNormalization()(c6)
    ...
    #1 c7 = tf.keras.layers.BatchNormalization()(c7)
