...
Training on the Larger model may result in better results, however it could also reduce accuracy due to the relatively small sample size of the ISIC dataset due to overfitting.
