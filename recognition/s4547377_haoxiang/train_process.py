...
#import the functions from other written files
from datasetgenerator import generateDataset
from styleGANmodel import StyledGenerator, Discriminator
...
if __name__ == '__main__':
    ...
    dataset = generateDataset(args.path, transform)
