...
## Results
---
The models are trained on the Google Colab pro with NVIDIA Tesla A100-SXM4-40GB GPU. The results are shown as follows:  
* 64X64 Images  
    IMAGE_SIZE = (64, 64)  
    BATCH_SIZE = 64  
    EPOCHS = 50  
...
The model did not converge well on the 256X256 size images.
<br> 
