...
folder = r"C:\Users\zillw\Desktop\yolo3-pytorch-master\yolo3-pytorch-master\dataset\VOC2007\mask_labeling"
...
for index, file_name in enumerate(files_name):
  ...
  # cv2.rectangle(imagess, (y_min, x_min), (y_max, x_max), (255, 0, 0), 1)
  # cv2.imshow("Image", imagess)
  # cv2.waitKey (0)
  # cv2.destroyAllWindows()
  # cv2.imwrite("dataset/mask_labeling/"+file_name, imagess)
