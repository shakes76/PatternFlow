...
def train(args, dataset, generator, discriminator):
    ...
    step = int(math.log2(args.init_size)) - 2  # 8:1,16:2 32:3 64:4 128:5 256:6
    resolution = 4 * 2 ** step
    loader = sample_data(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--init_size', default=125, type=int, help='initial image size')
    ...
    # args.ckpt = 'checkpoint/train_step-7.model'
