...
##### ModelArchitecture
The model used for this classification is an improved u-net structure taken from "should i write the name here?plagiarism?"
According to which, the input images are 
