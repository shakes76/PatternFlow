...
![vqvae](./images/vqvae_architecture.png)
### PixelCNN model
...
7. Used the trained PixelCNN to generate images. Some of the results with learning rates = 0.0001, 0.0003 and 0.0005 are stored in the images folder respectively(e.g. adam optimizer with learning rate 0.0003 is stored in images/lr = 0.0003). Below are some iamges generated using the PixelCNN trained:</br>
<p align="center">
<img src="./images/pixelcnn_result.png">
</p>
