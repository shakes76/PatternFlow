...
def improved_unet(input_shape=(256,256,1), batch_size=32):
    inputs = Input(input_shape, batch_size)
    ...
    seg3 = Conv2D(1, (1, 1), padding='same',activation=LeakyReLU(0.01))(local_module3)
    ...
    seg2 = Conv2D(1, (1, 1), padding='same',activation=LeakyReLU(0.01))(local_module2)
    ...
    seg1 = Conv2D(1, (1, 1), padding='same',activation=LeakyReLU(0.01))(conv1_1)
    up_seg2_3 = UpSampling2D(size=(2, 2))(add_seg2_3)
    add_seg1_2_3 = Add()([seg1, up_seg2_3])

    # Softmax
    outputs = Conv2D(1, (1, 1), activation = 'softmax')(add_seg1_2_3)
