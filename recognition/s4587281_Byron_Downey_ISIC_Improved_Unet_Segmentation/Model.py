...
def create_model(num_epochs, batch_size, input_shape, base_channels, dropout_rate, leaky_relu_slope, kernel_size, upsampling_kernel_size):
    ...
    residual1 = Add() ([initial_conv, context1_conv2])
    context1_batch_norm = BatchNormalization() (residual1)
    ...
    residual2 = Add() ([stride2_conv1, context2_conv2])
    context2_batch_norm = BatchNormalization() (residual2)
    ...
    residual3 = Add() ([stride2_conv2, context3_conv2])
    context3_batch_norm = BatchNormalization() (residual3)
    ...
    residual4 = Add() ([stride2_conv3, context4_conv2])
    context4_batch_norm = BatchNormalization() (residual4)
    ...
    residual5 = Add() ([stride2_conv4, context5_conv2])
    context5_batch_norm = BatchNormalization() (residual5)
