# Adapted from the example in the Keras documentation
...
# Vector quantizer - the layer that sits between the encoder and decoder
...
# ~~~~ PixelCNN ~~~~ #
# The code for this generative model was taken from
