...
Source: unixpickle on GitHub
URL: https://github.com/unixpickle/vq-vae-2/blob/6874db74dbc8e7a24c33303c0aa12d66d803c725/vq_vae_2/attention.py
"""
...
class PixelAttention(nn.Module):
    ...
    def forward(self, *images, conds=None):
        ...
        for image in images:
            ...
            result = image.permute(0, 2, 3, 1).contiguous()
...
class MaskedAttention(nn.Module):
    ...
    def forward(self, sequence):
        ...
        logits = torch.bmm(queries, keys.permute(0, 2, 1).contiguous())
