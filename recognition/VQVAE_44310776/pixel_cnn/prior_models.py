...
URL: https://github.com/unixpickle/vq-vae-2/blob/master/vq_vae_2/examples/hierarchical/model.py
"""
...
from .pixel_cnn import ChannelNorm, PixelCNN, PixelConvA, PixelConvB
