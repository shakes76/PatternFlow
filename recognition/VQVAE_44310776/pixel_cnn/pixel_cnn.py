...
URL: https://github.com/unixpickle/vq-vae-2/blob/6874db74dbc8e7a24c33303c0aa12d66d803c725/vq_vae_2/pixel_cnn.py
"""
...
class PixelConv(nn.Module):
    ...
    def _compute_cond_bias(self, conds):
        ...
        conds_perm = conds.permute(0, 2, 3, 1).contiguous()
