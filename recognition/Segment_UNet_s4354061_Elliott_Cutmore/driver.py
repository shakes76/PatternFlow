...
if __name__ == "__main__":
    ...
    if option == 1:
        ...
        # train_gen = create_generator(train_input, train_target, batch_size, img_dims, num_classes)
        # val_gen = create_generator(val_input, val_target, batch_size, img_dims, num_classes)
        # test_gen = create_generator(test_input, test_target, batch_size, img_dims, num_classes)
        #
        # # Check that generators work loading in images and visualise some:
        # check_generator(train_gen, img_dims, batch_size, num_classes, visualise=True)
        # check_generator(val_gen, img_dims, batch_size, num_classes, visualise=True)
        # check_generator(test_gen, img_dims, batch_size, num_classes, visualise=True)
        #
        ...
        #                       save_model_filename=save_model_path,
