...
class Generator256(Model):
    ...
    def __init__(self):
        ...
        self.layer_input = tf.keras.Input(shape=100)
        self.layer_dense_0 = layers.Dense(8 * 8 * 1024, use_bias=False, input_shape=(100,))
        self.layer_batch_norm_0 = layers.BatchNormalization()
        self.layer_lrelu_0 = layers.LeakyReLU()

        self.layer_reshape_0 = layers.Reshape((8, 8, 1024))

        self.layer_conv2d_1 = layers.Conv2DTranspose(1024, (3, 3), strides=(1, 1), padding='same', use_bias=False)
        self.layer_batch_norm_1 = layers.BatchNormalization()
        self.layer_lrelu_1 = layers.LeakyReLU()

        self.layer_conv2d_2 = layers.Conv2DTranspose(512, (3, 3), strides=(2, 2), padding='same', use_bias=False)
        self.layer_batch_norm_2 = layers.BatchNormalization()
        self.layer_lrelu_2 = layers.LeakyReLU()

        self.layer_conv2d_3 = layers.Conv2DTranspose(256, (3, 3), strides=(2, 2), padding='same', use_bias=False)
        self.layer_batch_norm_3 = layers.BatchNormalization()
        self.layer_lrelu_3 = layers.LeakyReLU()

        self.layer_conv2d_4 = layers.Conv2DTranspose(128, (3, 3), strides=(2, 2), padding='same', use_bias=False)
        self.layer_batch_norm_4 = layers.BatchNormalization()
        self.layer_lrelu_4 = layers.LeakyReLU()

        self.layer_conv2d_5 = layers.Conv2DTranspose(64, (3, 3), strides=(2, 2), padding='same', use_bias=False)
        self.layer_batch_norm_5 = layers.BatchNormalization()
        self.layer_lrelu_5 = layers.LeakyReLU()
