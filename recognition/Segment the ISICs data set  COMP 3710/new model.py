...
class Unet(keras.Model):
    def __init__(self):
        ...
        self.drop4 = layers.Dropout(0.5, name="drop4") # preventing over-training
        ...
        self.drop5 = layers.Dropout(0.5, name="drop5")
    ...
    def call(self, input, training=False):
        ...
        down_pool4 = self.down_pool4(drop4)

        conv5_1 = self.conv5_1(down_pool4)
        conv5_2 = self.conv5_2(conv5_1)
        drop5 = self.drop5(conv5_2)

        upsampling6 = self.upsampling6(drop5)
