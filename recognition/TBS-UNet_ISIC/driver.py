...
# train the network
network.trainModel(trainData, trainLabels, valData, valLabels, 30)
...
testPredictions = network.modelPredict(testData)
...
samplePrediction_1 = network.modelPredict(testData[0:1])
samplePrediction_2 = network.modelPredict(testData[10:11])
