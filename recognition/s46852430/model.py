...
from tensorflow.keras.layers import UpSampling2D, MaxPooling2D, Conv2D, Conv2DTranspose,Conv3D,Conv3DTranspose
...
def modified_UNET(input_shape, num_filter = 8, dropout = 0.3):
  ...
  p2 = MaxPooling2D(pool_size= 2 ,strides=2)(c2)
  p2 = Dropout(dropout)(p2)

  c3 = conv_block(p2,num_filter*4);
  p3 = MaxPooling2D(pool_size= 2 ,strides=2)(c3)
  p3 = Dropout(dropout)(p3)
  
  c4 = conv_block(p3,num_filter*8);
  p4 = MaxPooling2D(pool_size= 2 ,strides=2)(c4)
  ...
  u7 = Conv2DTranspose(num_filter*4, 3,strides = 2, padding= 'same')(c6);

  u7 = concatenate([u7,c3]);
  c7 = conv_block(u7,num_filter*4)
  c7 = Dropout(dropout)(c7)
  u8 = Conv2DTranspose(num_filter*2, 3,strides = 2, padding='same')(c7);
  u8 = concatenate([u8,c2]);

  c8 = conv_block(u8,num_filter*2)
  c8 = Dropout(dropout)(c8)
  u9 = Conv2DTranspose(num_filter, 3,strides = 2, padding='same')(c8);
